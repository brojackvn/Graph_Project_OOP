...
public class MyGraph {
    ...
    public void inputData() {
        Scanner input = null;
        File file = new File("D:\\Programming language\\Java\\Project Practice OOP\\MainGraphProject\\src\\main\\java\\LearnGraphStream\\data.txt");
        try {
    ...
    public void simulationDFS() {
        ArrayList<Integer> arrayTemp1 = new ArrayList<>();
        arrayTemp1 = allPath.get(5);
...
//
//        label.setPreferredSize(new Dimension((int) tk.getScreenSize().getWidth(), (int) tk.getScreenSize().getHeight()/10));
//        label.setBackground(Color.GRAY);
//        label.setOpaque(true);
//
//        panel.setBackground(Color.ORANGE);
//        panel.setPreferredSize(new Dimension((int) tk.getScreenSize().getWidth(), (int) tk.getScreenSize().getHeight()/10));
//
//        frame.setLayout(new BorderLayout());
//        frame.setExtendedState(Frame.MAXIMIZED_BOTH);
//        frame.setTitle("Project OOP");
